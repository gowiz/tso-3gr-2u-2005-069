...
\begin{mdframed}
\begin{align*}
\forall a \in \mathbb{R}_0, \forall n\in \mathbb{N}: a^{-n} = \left(a^{-1}\right)^n=\left(a^n\right)^{-1}=\dfrac{1}{a^n}
\end{align*}
\end{mdframed}
...
\begin{enumerate}[(a)]
  ...
  \item $\dfrac{8^2}{2^5}$ {\em\small hint: schrijf eerst 8 als een macht met grondtal 2}
...
\begin{oefening}
Bereken door zo min mogelijk gebruik te maken van $n$-de machtswortels:
\begin{multicols}{2}
\begin{enumerate}[(a)]
  \itemsep.5em
  \item $8^{\frac{1}{3}}$
  ...
  \item $1^{-\frac{2}{5}}$
  \item $65^{-\frac{2}{3}}\left(\dfrac{130}{2}\right)^{-\frac{1}{3}}$
...
\begin{oefening}
Bereken volgende logaritmen, maak steeds gebruik van de rekenregels voor logaritmen:\\
\begin{multicols}{2}
\begin{enumerate}[(a)]
  \itemsep1em
  \item $\log (100\cdot 10)$
  \item $\log \dfrac{100}{1000}$
  \item $\log 0.01$
  \item $\log 1000^6$
\end{enumerate}
\end{multicols}
