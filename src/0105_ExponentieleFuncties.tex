...
\renewcommand\descriptionlabel[1]{\hspace{1em} $\bullet$ \textbf{#1}}
...
\begin{oefening}
  ...
  \item Bepaal nu bij benadering wat
    $$10^{\sqrt[3]{215}}$$
    is.
    \item Controleer dit resultaat nu m.b.v. het \zrm{ZRM}.
  \end{enumerate}
\end{oefening}

\begin{oefening}
Verklaar waarom je \zrm{ZRM} de macht $(-5)^\pi$ niet kan uitrekenen.
\end{oefening}
...
\paragraph{Rekenmachine:} We kunnen de logaritmen berekenen op het \zrm{ZRM} met de toets \zrm{log}. Zo is $\log 1000 = 3$, wat ons niet verbaast. We kunnen gerust andere logaritmen berekenen, zo is $\log 5678 \approx 3.75$.
...
\begin{oefening}
Bereken volgende logaritmen, maak steeds gebruik van de rekenregels voor logaritmen, gebruik geen \zrm{ZRM}:
\begin{multicols}{2}
  \begin{enumerate}[(a)]
    \itemsep1em
  \item $\log 25 + \log 4$
