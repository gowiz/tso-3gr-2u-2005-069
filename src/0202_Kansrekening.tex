...
\paragraph{Voorbeeld}
We gooien lukraak met een zuivere dobbelsteen. Bereken de kans dat we een priemgetal of een even getal gooien.

\begin{oefening}
Uit een spel van 52 kaarten trekken we lukraak een kaart. Hoe groot is de kans dat de getrokken kaart een harten of een persoon is?
\end{oefening}

\begin{oefening}
  We trekken een lotje uit een serie lotjes met de nummers $10, 11, 12, \ldots, 99$. Hoe groot is de kans dat we een lotje trekken met het cijfer $2$ in het lotnummer?
\end{oefening}
...
\begin{oefening}\\
  \begin{minipage}{.7\linewidth}
    Sinds oktober 2011 gebruikt de Belgische lotto $45$ balletjes met op elk een verschillend nummer van $1$ tot en met $45$. Om mee te doen aan de lotto moet je $6$ kruisjes zetten op een rooster.
    \begin{enumerate}[(a)]
    \item Wat is de kans dat je de lotto wint als je de getallen $1$ tot en met $6$ kiest?
    \item Wat is de kans dat je de lotto wint als je jouw $6$ favoriete getallen kiest?
    \item Hoeveel roosters moet je invullen om zeker éénmaal het juiste rooster in te vullen?
    \item Hoeveel geef je daarvoor uit, als één rooster 1.25 euro kost?
    \item Wat is de kans dat een lotto trekking zeker het getal $42$ bevat?
    \end{enumerate}
  \end{minipage}
  \hfill
  \begin{minipage}{.27\linewidth}
    \vspace{-.5em}
    \includegraphics[width=\textwidth]{lotto}
  \end{minipage}
\end{oefening}
