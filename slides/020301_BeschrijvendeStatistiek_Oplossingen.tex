...
\begin{enumerate}[(a)]
  ...
  \item Teken de boxplot.
    \includegraphics[width=\textwidth]{uitzendbureau-boxplot.pdf}
  \end{enumerate}
  Opmerking: Die kruisjes in bovenstaande boxplot zijn de uitschieters, als je een boxplot met de hand tekent hoeven deze er niet op te staan.
\end{frame}
